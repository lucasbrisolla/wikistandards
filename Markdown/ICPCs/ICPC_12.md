...
2. (a) seja  reconhecido  como  parte  do  custo  de  item  do  imobilizado  de  acordo  com  o Pronunciamento Técnico CPC 27 - Ativo Imobilizado; e
3. (a)  seja reconhecido como parte do custo de item do imobilizado, de acordo com o CPC 27 Ativo Imobilizado, ou como parte do custo de ativo de direito de uso de acordo com o CPC 06; e (Alterada pela Revis ã o CPC 13)
4. (b) seja  reconhecido  como  passivo  de  acordo  com  o  Pronunciamento  Técnico  CPC  25  Provisões, Passivos Contingentes e Ativos Contingentes.
...
2. (a) mudança no fluxo de saída estimado de recursos que incorporam benefícios econômicos (por exemplo, fluxos de caixa) necessários para liquidar a obrigação;
3. (b) mudança na taxa de desconto corrente baseada em mercado, conforme definida no item 47  do  Pronunciamento  Técnico  CPC  25  -  Provisões,  Passivos  Contingentes  e  Ativos Contingentes (isso inclui mudanças no valor temporal do dinheiro e os riscos específicos do passivo); e
4. (c) aumento  que  reflete  a  passagem  do  tempo  (também  referido  como  a  reversão  do desconto).
...
| Depreciação acumulada (1)          |   $ 3.420 |    $ |
|------------------------------------|-----------|------|
| C Ativo Reserva de reavaliação (2) |      8.98 | 3.42 |
| C Ativo (3)                        |           | 8.98 |
...
4. EI12  Após essa avaliação, os valores incluídos no balanço patrimonial são:
...
- EI13  A  aplicação  retrospectiva  é  exigida  pelo  Pronunciamento  Técnico  CPC  23  -  Políticas Contábeis,  Mudança  de  Estimativa  e  Retificação  de  Erro,  quando  praticável.  O  exemplo seguinte ilustra a aplicação retrospectiva da Interpretação para preparador que:
