...
| QUESTÕES                                                      | 6       |
| CONSENSO                                                      | 7 - 13  |
| Contabilização de participação em fundo                       | 7 - 9   |
| Contabilização de obrigação de fazer contribuições adicionais | 10      |
| Divulgação                                                    | 11 - 13 |
| VIGÊNCIA                                                      | 14      |
...
- CPC 35 - Demonstrações Separadas (Eliminado pela Revisão ICPC 01)
- Interpretação  anexa  ao  CPC  36  -  Demonstrações  Consolidadas  -  Entidade  de  Propósito Específico (Eliminado pela Revisão ICPC 01)
...
Conjunto (Alterado pela Revisão ICPC 01)

- CPC 19 - Investimento em Empreendimento Controlado em Conjunto ( Joint Venture )
- CPC 19 - Negócios em Conjunto (Alterado pela Revisão ICPC 01)
...
3. (a) fundos  que  são  estabelecidos  por  um  único  contribuinte  para  custear  suas  próprias obrigações  por  desativação,  seja  para  um  local  específico  ou  para  uma  série  de  locais geograficamente dispersos;
...
2. (a) os  ativos  são  administrados  separadamente  (por  serem  mantidos  em  entidade  legal separada ou como ativos segregados dentro de outra entidade); e
3. (b) o direito do contribuinte de acessar os ativos é restrito.
...
2. (a) como a entidade (contribuinte) deve contabilizar a sua participação no fundo?
3. (b) quando a entidade (contribuinte) tiver obrigação de fazer contribuições adicionais, como, por  exemplo,  no  caso  de  falência  de  outro  contribuinte,  como  essa  obrigação  deve  ser contabilizada?
...
3. (a) o valor da obrigação por desativação reconhecida; e
4. (b) a  parcela  do  contribuinte  no  valor  justo  dos  ativos  líquidos  do  fundo  atribuíveis  aos contribuintes.
