<div class="standard-header">
  <h1 class="standard-title">CPC 06 (R2) · Arrendamentos</h1>
  <p class="standard-summary">Pronunciamento Técnico CPC · <strong>IFRS 16</strong></p>
</div>
...
### Classificação de arrendamento (itens 61 a 66)
...
![Fluxograma do item B31 sobre avaliação de contrato de arrendamento](../../assets/cpc-06-b31-fluxograma.png)
