...
Use esta página como guia rápido para escolher a melhor rota de consulta.
...
- A coluna da norma abre o texto preservado da norma.
- A coluna de título ajuda a localizar o assunto sem depender apenas do código.
- As colunas de relação apontam correspondências catalogadas, quando disponíveis.

## Observação de Curadoria

O texto das normas é preservado como fonte. As páginas de catálogo, mapas e equivalências servem para facilitar localização, navegação e comparação.
